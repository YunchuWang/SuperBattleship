...
*/
var compselection = new Set();
var userselection = new Set();
var p1shipcollection = new Set();
var compshipcollection = new Set();
const GRIDVAL = 12;
var myturn = true;
var result = false;
var cyan = "#3A77E4";
...
SBConstants.randir = function() {
	var num = Math.floor((Math.random() * 4) + 1);
	switch (num) {
    case 1: return SBConstants.NORTH; 
    case 2: return SBConstants.SOUTH;
    case 3: return SBConstants.WEST;
    case 4: return SBConstants.EAST;
    }
}
